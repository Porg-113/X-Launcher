...
const translations = {
  de: {
    ...
    "downloads.copy": "Lade X Client herunter, melde dich mit Microsoft an oder spiele offline und starte direkt in dein Minecraft.",
  ...
  en: {
    ...
    "downloads.copy": "Download X Client, sign in with Microsoft or play offline, and jump straight into Minecraft.",
